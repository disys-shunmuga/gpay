...
sanjeev=google_pay.Google_pay("sanjeev.sp@gmail.com","9003085347","sanjeevsp")
sanjeev.open_gpay()
sanjeev.email_verification()
sanjeev.mobile_verification()
sanjeev.name_verification()
sanjeev.otp_verification(15698,15698)
sanjeev.Bank_verification()
sanjeev.PanCard_Verification()
sanjeev.set_Pin("0304")
sanjeev.Enter_your_Pin(3465,3465)

class Phone_pe(google_pay.Google_pay):                                                                                          #INHERITANCE
...
sp=Phone_pe("sanjeevas94@gmail.com","9003085347","sanjeev")
sp.open_phonepe()
sp.mobile_verification()
sp.name_verification()
sp.otp_verification(780965,780965)
sp.Bank_verification()
sp.PanCard_Verification()
sp.set_Pin("987654")
sp.Enter_your_Pin(3564,3564)


        
googlepay=[{"name":"sanjeev","gpaynum":7397266887,"type":"personal","transaction":"regular"},                       #DICTIONARY INSIDE LIST
           {"name":"abishek","gpaynum":7305341565,"type":"personal","transaction":"regular"},
           ...
           {"name":"aandha","gpaynum":8015341851,"type":"personal","transaction":"rare"},
